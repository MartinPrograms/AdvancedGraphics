...
public class VaSwapchain
{
    ...
    public unsafe void Destroy()
    {
        ...
        {
            vk.DestroyImageView(VaContext.Current.Device, DepthImageViews[i], null);
            vk.DestroyImage(VaContext.Current.Device, DepthImages[i], null);
            vk.FreeMemory(VaContext.Current.Device, DepthImageMemory[i], null);
        }
