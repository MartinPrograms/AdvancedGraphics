...
public class CommandHelper
{
    ...
    public static unsafe void EndSingleTimeCommands(Device device, Queue queue, CommandPool commandPool, CommandBuffer commandBuffer, Fence f)
    {
        var vk = VaContext.Current?.Vk;
        if (vk == null)
        {
        ...
        vk.QueueSubmit(queue, 1, &submitInfo, f);
